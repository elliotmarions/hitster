-- =====================================================================
--  LÅTSNURRAN – Byt namn på vinst-eventet → GAME_WIN
--
--  Vinst-eventet som mark_cross loggar i room_events får ett neutralt namn:
--  GAME_WIN. mark_cross definieras om, identisk med 0011 så när som på
--  event-strängen. (Eventet konsumeras inte av klienten – vinst visas via
--  rooms.status – så bytet är riskfritt.)
--
--  Additiv + idempotent. Kör efter 0014.
-- =====================================================================
